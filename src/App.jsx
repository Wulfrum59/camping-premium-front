      ...
      <section className="hebergements-section">
        ...
        <div className="hebergements-cards">
          ...
          <div className="card-hebergement">
            ...
            <h3>Tente</h3>
            <button className="btn-card" onClick={() => window.location.href = "/tente"}>Découvrir</button>
          </div>

          <div className="card-hebergement">
            <img src="src/assets/mobilehome.jpg" alt="Mobil-home" />
            <h3>Mobil-home</h3>
            <button className="btn-card" onClick={() => window.location.href = "/mobilhome"}>Découvrir</button>
          </div>

          <div className="card-hebergement">
            <img src="src/assets/borddemer.jpg" alt="Studio en bord de mer" />
            <h3>Studio en bord de mer</h3>
            <button className="btn-card" onClick={() => window.location.href = "/appartement"}>Découvrir</button>
          </div>

          <div className="card-hebergement">
            <img src="src/assets/chalet.jpg" alt="Chalet" />
            <h3>Chalet</h3>
            <button className="btn-card" onClick={() => window.location.href = "/maison"}>Découvrir</button>
          </div>
